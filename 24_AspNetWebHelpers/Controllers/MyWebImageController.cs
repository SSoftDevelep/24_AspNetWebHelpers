...
namespace _24_AspNetWebHelpers.Controllers
{
    public class MyWebImageController : Controller
    {
        ...
        {
            get { return Server.MapPath("~/Images/sait.jpg"); }
        }
        ...
        public void Process(string p)
        {
            ...
            switch (p)
            {
                ...
                case "FlipVertical":
                    ...
                    break;
                case "Resize":
                    image.Resize(image.Width / 2, image.Height / 2, preserveAspectRatio: true); //preserveAspectRatio cozunurluk bozulmadan demek.
                    break;
                case "AddTextWatermark":
                    image.AddTextWatermark("Mazhar Fuat Ozkan", fontColor: "Red", fontSize: 14, horizontalAlign: "Center", verticalAlign: "Bottom");
                    break;
